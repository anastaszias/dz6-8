public class Main {
    public static void main (String[] args){
        ...
        String lenght1=.format("%5.3f",example1.lenghtCircle());
        String square1=.format("%5.3f",example1.squareCircle());
        String lenght2 2=String.format("%5.3f",example2 lenghtCircle());
        String ==.format("%5.3f",example2.squareCircle());
